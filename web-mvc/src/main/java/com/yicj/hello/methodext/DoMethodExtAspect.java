package com.yicj.hello.methodext;
...
public class DoMethodExtAspect {
    private Logger logger = LoggerFactory.getLogger(DoMethodExtAspect.class);

    @Pointcut("@annotation(com.yicj.hello.methodext.DoMethodExt)")
